...
Buka Google Colab
`File` → `Upload notebook` → pilih `Dimensionality_Reduction_PCA_tSNE.ipynb`
Upload `ecommerce_customer_behavior.csv` ke sesi (ikon 📁 di sidebar kiri)
`Runtime` → `Run all` ▶️
...
👥 Kelompok
Nama	NIM	Peran
Orian Edsel Devaninra	24523149	
Muhammad Rifki Apreliant	24523097	
